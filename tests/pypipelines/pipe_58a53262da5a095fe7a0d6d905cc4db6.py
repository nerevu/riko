...
def pipe_58a53262da5a095fe7a0d6d905cc4db6(
    ...
    sw_550 = fetch(
        ...
        conf={
            "URL": [
                {"type": "url", "value": get_path("blog.ouseful.info_feed.xml")},
                {
                    "type": "url",
                    "value": get_path("feeds.feedburner.com_TheEdTechie.xml"),
                },
            ]
        },
    )
    ...
    sw_580 = union(sw_550, context=context, _OTHER=sw_572, conf={})
