...
regex_rule = [
    ...
    make_regex_conf_rule("k:job_type", match1_03, "hourly", seriesmatch=False),
    make_regex_conf_rule("k:job_type", match1_04, "fixed", seriesmatch=False),
    ...
    make_regex_conf_rule("k:tags", match1_15, "$4", seriesmatch=False),
    make_regex_conf_rule("k:tags", match1_16, "$4", seriesmatch=False),
    make_regex_conf_rule("k:tags", match1_17, "$3", seriesmatch=False),
    make_regex_conf_rule("k:tags", match1_18, ","),
    # make_regex_conf_rule('k:tags', match1_19, '$1,'),
    make_regex_conf_rule("k:tags", match1_20a, ","),
    make_regex_conf_rule("k:tags", match1_21a, "-"),
