...
regex1_rule = [
    build_regex_conf_rule("title", match1_01, "$1"),
    build_regex_conf_rule("k:marketplace", match1_02, "$3"),
    build_regex_conf_rule("k:job_type", match1_03, "hourly"),
    build_regex_conf_rule("k:job_type", match1_04, "fixed"),
    build_regex_conf_rule("k:job_type", match1_05, "unknown"),
    build_regex_conf_rule("k:job_type", ".*hr.*", "hourly"),
    build_regex_conf_rule("k:job_type", ".*unknown.*", "unknown"),
    build_regex_conf_rule("k:job_type", "^(?!.*(hourly|unknown).*).*", "fixed"),
    build_regex_conf_rule("k:content", match1_06, "$1"),
    build_regex_conf_rule("k:content", match1_07, "$3"),
    build_regex_conf_rule("k:submissions", match1_08, "$3"),
    build_regex_conf_rule("k:submissions", match1_09, "unknown"),
    build_regex_conf_rule("k:author", match1_10, "$3"),
    build_regex_conf_rule("k:author", match1_11, "unknown"),
    build_regex_conf_rule("k:work_location", match1_12, "$4"),
    build_regex_conf_rule("k:work_location", match1_13, "unknown"),
    build_regex_conf_rule("k:client_location", match1_14, "$4"),
    build_regex_conf_rule("k:client_location", match1_14b, "unknown"),
    build_regex_conf_rule("k:tags", match1_15, "$4"),
    build_regex_conf_rule("k:tags", match1_16, "$4"),
    build_regex_conf_rule("k:tags", match1_17, "$3"),
    build_regex_conf_rule("k:tags", match1_18, ""),
    build_regex_conf_rule("k:tags", match1_19, "$1,"),
    build_regex_conf_rule("k:tags", match1_20b, ","),
    build_regex_conf_rule("k:tags", match1_21b, "-"),
    build_regex_conf_rule("k:tags", "^-|-$", ""),
    build_regex_conf_rule("k:tags", ",-|-,", ","),
    build_regex_conf_rule("k:tags", "^,|,$", ""),
    build_regex_conf_rule("k:due", match1_22, "$1"),
    build_regex_conf_rule("k:due", match1_23, "unknown"),
    build_regex_conf_rule("k:budget_raw", match1_24b1, "0", seriesmatch=False),
    build_regex_conf_rule("k:budget_raw", match1_24b2, "$5", seriesmatch=False),
    build_regex_conf_rule("k:budget_raw", "k", "000"),
    build_regex_conf_rule("k:budget_raw", match1_25, "0 -"),
    build_regex_conf_rule("k:budget_raw", "or less", "- 0"),
    build_regex_conf_rule("k:budget_raw", match1_26, "$1 - $1"),
]

regex2_rule = [
    build_regex_conf_rule("k:budget_raw1", "(.*) - (.*)", "$1"),
    build_regex_conf_rule("k:budget_raw2", "(.*) - (.*)", "$2"),
]

regex3_rule = [
    build_regex_conf_rule("k:budget_raw1_num", "[^\\d]*(\\d+\\.?\\d*).*", "$1"),
    build_regex_conf_rule("k:budget_raw1_sym", "\\s*([$£€₹]).*", "$1"),
    build_regex_conf_rule("k:budget_raw1_code", ".*(\\b[A-Z]{3}\\b).*", "$1"),
    build_regex_conf_rule("k:budget_raw2_num", "[^\\d]*(\\d+\\.?\\d*).*", "$1"),
    build_regex_conf_rule("k:budget_raw2_sym", "\\s*([$£€₹]).*", "$1"),
    build_regex_conf_rule("k:budget_raw2_code", ".*(\\b[A-Z]{3}\\b).*", "$1"),
]

regex4_rule = [
    build_regex_conf_rule("k:cur_code", "^(?![A-Z]{3}\\b)(.*)", DEF_CUR_CODE)
]
