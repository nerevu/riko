...
def pipe_8NMkiTW32xGvMbDKruymrA(context=None, _INPUT=None, conf=None, **kwargs):
    ...
    if context and context.describe_dependencies:
        return ["pipefetch", "pipefilter", "pipeoutput", "pipesort"]
    ...
    sw_35 = fetch(
        ...
        conf={
            "URL": [
                {
                    "type": "url",
                    "value": "file://data/www.fourtitude.com_news_publish_rss.xml",
                },
                {
                    "type": "url",
                    "value": "file://data/feeds.gawker.com_jalopnik_full.xml",
                },
                {"type": "url", "value": "file://data/www.autoblog.com_rss.xml"},
            ]
        },
    )
