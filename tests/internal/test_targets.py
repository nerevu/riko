...
the passthrough execution host (``riko.definitions.targets``/``riko.runtime._write_session``).
"""
...
from riko.definitions.resources import OneShotResource, _FactoryKind
from riko.definitions.targets import (
    File,
    WriteCapabilities,
    WriteResult,
    normalize_keys,
